...
const FOOTER = `
  <tr><td style="background:#000000;padding:0;font-family:Arial,sans-serif;color:#cfcfcf;">
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0"><tr>
      <td class="bis-col" style="padding:26px 32px;vertical-align:middle;">
      ...
      <td align="right" class="bis-col bis-center-sm" style="padding:26px 32px;vertical-align:middle;">
        <img src="https://cdn.shopify.com/s/files/1/1258/4351/files/Klarna_Payment_Badge.png?v=1782477265" alt="Klarna" height="34" style="height:34px;border:0;display:inline-block;">
      </td>
    </tr></table>
    <div style="border-top:1px solid #2a2a2a;margin:0 32px;"></div>
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0"><tr>
      <td class="bis-col" style="padding:22px 32px;vertical-align:top;font-size:13px;line-height:1.7;">
      ...
      <td align="right" class="bis-col bis-center-sm bis-pt-sm" style="padding:22px 32px;vertical-align:top;">
        <a href="https://maps.google.com/?q=CINEGEARPRO+LTD+London+E9+5HD"><img class="bis-img" src="https://cdn.shopify.com/s/files/1/1258/4351/files/Cgp_map.jpg?v=1782477265" alt="Map to CINEGEARPRO, London E9 5HD" width="220" style="width:220px;max-width:220px;border:0;display:block;border-radius:4px;"></a>
      </td>
    </tr></table>
